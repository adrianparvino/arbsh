...
double ___lgamma_r(double x, int *sg);

long double ___lgammal_r(long double x, int *sg)
{
	return ___lgamma_r(x, sg);
}
...
{
	return ___lgammal_r(x, &___signgam);
}

weak_alias(___lgammal_r, lgammal_r);
