...
static float sin_pif(float x)
{
	...
	switch (n) {
	case 0:  y =  ___sindf(pi*y); break;
	case 1:
	case 2:  y =  ___cosdf(pi*(0.5f - y)); break;
	case 3:
	case 4:  y =  ___sindf(pi*(1.0f - y)); break;
	case 5:
	case 6:  y = -___cosdf(pi*(y - 1.5f)); break;
	default: y =  ___sindf(pi*(y - 2.0f)); break;
	}
	return -y;
}


float ___lgammaf_r(float x, int *signgamp)
{
...
weak_alias(___lgammaf_r, lgammaf_r);
