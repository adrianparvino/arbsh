...
/*
 * ld80 version of ___tan.c.  See ___tan.c for most comments.
 */
/*
 * Domain [-0.67434, 0.67434], range ~[-2.25e-22, 1.921e-22]
 * |tan(x)/x - t(x)| < 2**-71.9
 *
 * See ___cosl.c for more details about the polynomial.
 */
...
long double ___tanl(long double x, long double y, int iy) {
